...
updateTipoPlatoRoute.put('/updatetipoplato', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id, Nombre, Descripcion, IdUsuario } = req.body;
    try {
        const newTipoPlato = new TipoPlato_1.default(Nombre, Descripcion, IdUsuario, id);
